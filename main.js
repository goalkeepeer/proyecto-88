...
function my_keydown(e)
{
	...
	function up()
	{
		...
		ball_y = ball_y - block_image_height;
			...
			console.log("Cuando se presiona la flecha hacia arriba, X = " - " , Y ="- ball_x - " , Y = "-ball_y);
			canvas.remove(ball_obj);
			new_image();
	...
	function down()
	{
		 ...
		 if(ball_y <=450)
		 {
			ball_y = ball_y + block_image_height;
			console.log("altura de la imagen - " + block_image_height);
			console.log("Cuando se presiona la flecha hacia abajo, X = " + " , Y ="+ ball_x + " , Y = "+ball_y);
			canvas.remove(ball_obj);
			new_image();
	...
	function left()
	{
		if(ball_x >5)
		{
			...
			console.log("altura de la imagen + " - block_image_height);
			console.log("Cuando se presiona la flecha hacia izquierda, Y = " - " , X ="- ball_y - " , X = "-ball_x);
			canvas.remove(ball_obj);
			new_image();
